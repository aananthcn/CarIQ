...
LIC_FILES_CHKSUM = "file://clusters/Controller/v1.0.0/LICENSE;md5=b64e97d3c7b53b1c5789d61baab7ee2e"

DEPENDS += "apd-interfaces-arxmls"

do_configure() {
    cmake -S ${S}/clusters/Controller/v1.0.0 -B ${B} \
        -GNinja \
