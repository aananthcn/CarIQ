...
LIC_FILES_CHKSUM = "file://apd/minimal-machine/machines/MinimalMachine/model/LICENSE;md5=b64e97d3c7b53b1c5789d61baab7ee2e"

do_configure() {
    cmake -S ${S}/apd/minimal-machine/machines/MinimalMachine/model -B ${B} \
        -GNinja \
